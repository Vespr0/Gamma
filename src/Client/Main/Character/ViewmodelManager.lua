...
local VIEWMODEL_WHITELIST =
	{ Game.Limbs.Torso, Game.Limbs.RightArm, Game.Limbs.LeftArm, Game.Limbs.RightLeg, "HumanoidRootPart", "Meshes" }
...
function ViewmodelManager:setupToolEvents()
	...
	self.backpack.events.ToolRemoved:Connect(function(index)
		...
		if not tool then
			return
		end -- TODO may cause ambiguous behaivor
