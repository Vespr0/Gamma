...
function ClientAbilityThrow:activate()
	...
	self.hitbox.Hit:Connect(function(entityID, hitPartName)
		local sound = SoundManager.New("Tools/Sword/FleshSlash", self:getCurrentFakeToolHandle(), "Effects")
		SoundManager.Play(sound, 0.5)
	...
	task.spawn(function()
		task.wait(0.2)
		local sound = SoundManager.New("Tools/Sword/Swing", self:getCurrentFakeToolHandle(), "Effects")
		SoundManager.Play(sound, 0.5)
