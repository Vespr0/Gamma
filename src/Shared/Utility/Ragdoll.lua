...
local function createBallSocket(part0, part1, c0, c1)
	...
	-- socket.LimitsEnabled = true -- Enforces rotational limit
	-- socket.UpperAngle = 80 -- Rotation for limbs
	-- socket.TwistLimitsEnabled = true -- Enforces twist limit
	-- socket.TwistLowerAngle = -60 -- Twists down
	-- socket.TwistUpperAngle = 60 -- Twists up
...
-- 	local hitbox = bodyPart:Clone()
-- 	hitbox.Size = bodyPart.Size * 0.8
-- 	hitbox.Parent = bodyPart.Parent
-- 	hitbox.Transparency = 1
-- 	hitbox.Massless = true
-- 	hitbox.CanCollide = true
-- 	hitbox.Size *= 0.8
-- 	hitbox.Name = "Hitbox" .. bodyPart.Name
...
-- 	-- Make sure it's on the server and that the dummified part is in the workspace.
-- 	if IS_SERVER and bodyPart:IsDescendantOf(workspace) then
-- 		bodyPart:SetNetworkOwner(nil)
-- 		hitbox:SetNetworkOwner(nil)
-- 	end
-- 	table.insert(self._hitboxes, hitbox)
-- 	return hitbox
-- end
...
function Ragdoll:DisableRagdoll()
	...
	-- for _, part in ipairs(self._hitboxes) do
	-- 	part:Destroy()
	-- end
	-- self._hitboxes = {}
